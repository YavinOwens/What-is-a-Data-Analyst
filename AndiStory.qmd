...
```{mermaid}
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#01579b', 'primaryTextColor': '#01579b', 'primaryBorderColor': '#01579b', 'secondaryColor': '#fff3e0', 'secondaryTextColor': '#ff6f00', 'secondaryBorderColor': '#ff6f00' }}}%%
flowchart LR
    ...
    style L1,M1,N1,O1,P1,S1,T1,U1,V1 fill:#fff3e0,stroke:#ff6f00,stroke-width:2px
...
<script>
function downloadAsJPEG(filename) {
